...
ENREGISTRER_PROBLEME(836, "A Bold Proposition") {
    ...
    //
    // We consider an <b>open oriented line section</b> $U$ of $A$ with normalized Haar measure
    // $m$.
    //
    // Define $f(m, p)$ as the maximal possible discriminant of the <b>jacobian</b> associated
