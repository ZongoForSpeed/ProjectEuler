...
ENREGISTRER_PROBLEME(311, "Biclinic Integral Quadrilaterals") {
    // BCD is a convex, integer sided quadrilateral with 1 ≤ AB < BC < CD < AD. BD has integer length. O is the midpoint
    // of BD. AO has integer length. We'll call ABCD a biclinic integral quadrilateral if AO = CO ≤ BO = DO.
    //
