...
#pragma clang diagnostic pop
    ...
    struct Main {
        ...
        Main(const std::string &carte1,
            ...
            cartes.emplace_back(carte1);
            cartes.emplace_back(carte2);
            cartes.emplace_back(carte3);
            cartes.emplace_back(carte4);
            cartes.emplace_back(carte5);
        ...
        [[nodiscard]] unsigned short carre() const {
            if ((cartes.at(0).valeur == cartes.at(1).valeur && cartes.at(0).valeur == cartes.at(2).valeur &&
                ...
                || (cartes.at(1).valeur == cartes.at(2).valeur && cartes.at(1).valeur == cartes.at(3).valeur &&
                    cartes.at(1).valeur == cartes.at(4).valeur))
                return cartes.at(2).valeur;
            return 0;
        }
