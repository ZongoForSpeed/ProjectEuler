        ...
        for (nombre a1 = 0; a1 < taille; ++a1)
            for (nombre a2 = a1 + 1; a2 < taille; ++a2)
                for (nombre a3 = a2 + 1; a3 < taille; ++a3)
                    for (nombre b1 = a1 + 1; b1 < a3; ++b1)
                        if (b1 != a2)
                            for (nombre b2 = b1 + 1; b2 < taille; ++b2)
                                if (b2 != a2 && b2 != a3)
                                    for (nombre b3 = b2 + 1; b3 < taille; ++b3)
                                        if (b3 != a2 && b3 != a3)
                                            if (a2 > b2 || a3 > b3) {
                                                ++resultat;
                                            }
            ...
            for (nombre a2 = a1 + 1; a2 < taille; ++a2)
                for (nombre a3 = a2 + 1; a3 < taille; ++a3)
                    for (nombre a4 = a3 + 1; a4 < taille; ++a4)
                        for (nombre b1 = a1 + 1; b1 < a4; ++b1)
                            if (b1 != a2 && b1 != a3)
                                for (nombre b2 = b1 + 1; b2 < taille; ++b2)
                                    if (b2 != a2 && b2 != a3 && b2 != a4)
                                        for (nombre b3 = b2 + 1; b3 < taille; ++b3)
                                            if (b3 != a2 && b3 != a3 && b3 != a4)
                                                for (nombre b4 = b3 + 1; b4 < taille; ++b4)
                                                ...
                                                if (b3 != a2 && b3 != a3 && b3 != a4 && b3 != a5)
                                                    for (nombre b4 = b3 + 1; b4 < taille; ++b4)
                                                        if (b4 != a2 && b4 != a3 && b4 != a4 && b4 != a5)
                                                            for (nombre b5 = b4 + 1; b5 < taille; ++b5)
                                                        ...
                                                        for (nombre b4 = b3 + 1; b4 < taille; ++b4)
                                                            if (b4 != a2 && b4 != a3 && b4 != a4 && b4 != a5 &&
                                                                ...
                                                                for (nombre b5 = b4 + 1; b5 < taille; ++b5)
                                                                    if (b5 != a2 && b5 != a3 && b5 != a4 && b5 != a5 &&
                                                                        b5 != a6)
                                                                        for (nombre b6 = b5 + 1; b6 < taille; ++b6)
