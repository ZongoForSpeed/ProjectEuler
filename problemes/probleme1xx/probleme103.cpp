...
namespace {
    bool verifier(const vecteur &champs) {
        ...
        if (taille > 4
            && champs.front() + champs.at(1) + champs.at(2) <= champs.back() + champs.at(taille - 2))
            return false;

        if (taille > 6
            && champs.front() + champs.at(1) + champs.at(2) + champs.at(3) <=
            ...
            for (size_t a1 = 0; a1 < taille; ++a1)
                for (size_t a2 = a1 + 1; a2 < taille; ++a2)
                    for (size_t a3 = a2 + 1; a3 < taille; ++a3)
                        for (size_t b1 = a1 + 1; b1 < a3; ++b1)
                            if (b1 != a2)
                                for (size_t b2 = b1 + 1; b2 < taille; ++b2)
                                    if (b2 != a2 && b2 != a3)
                                        for (size_t b3 = b2 + 1; b3 < taille; ++b3)
                                            if (b3 != a2 && b3 != a3) {
                                                if (champs.at(a1) + champs.at(a2) + champs.at(a3) ==
                ...
                for (size_t a2 = a1 + 1; a2 < taille; ++a2)
                    for (size_t a3 = a2 + 1; a3 < taille; ++a3)
                        for (size_t a4 = a3 + 1; a4 < taille; ++a4)
                            for (size_t b1 = a1 + 1; b1 < a4; ++b1)
                                if (b1 != a2 && b1 != a3)
                                    for (size_t b2 = b1 + 1; b2 < taille; ++b2)
                                        if (b2 != a2 && b2 != a3 && b2 != a4)
                                            for (size_t b3 = b2 + 1; b3 < taille; ++b3)
                                                if (b3 != a2 && b3 != a3 && b3 != a4)
                                                    for (size_t b4 = b3 + 1; b4 < taille; ++b4)
                                                        if (b4 != a2 && b4 != a3 && b4 != a4) {
                                                            if (champs.at(a1) + champs.at(a2) + champs.at(a3) +
                                                                champs.at(a4) ==
                                                                champs.at(b1) + champs.at(b2) + champs.at(b3) +
                                                                champs.at(b4))
                    ...
                    for (size_t a3 = a2 + 1; a3 < taille; ++a3)
                        for (size_t a4 = a3 + 1; a4 < taille; ++a4)
                            for (size_t a5 = a4 + 1; a5 < taille; ++a5)
                                for (size_t b1 = a1 + 1; b1 < a5; ++b1)
                                    if (b1 != a2 && b1 != a3 && b1 != a4)
                                        for (size_t b2 = b1 + 1; b2 < taille; ++b2)
                                            if (b2 != a2 && b2 != a3 && b2 != a4 && b2 != a5)
                                                for (size_t b3 = b2 + 1; b3 < taille; ++b3)
                                                    if (b3 != a2 && b3 != a3 && b3 != a4 && b3 != a5)
                                                        for (size_t b4 = b3 + 1; b4 < taille; ++b4)
                                                            if (b4 != a2 && b4 != a3 && b4 != a4 && b4 != a5)
                                                                for (size_t b5 = b4 + 1; b5 < taille; ++b5)
                                                                    if (b5 != a2 && b5 != a3 && b5 != a4 && b5 != a5) {
                                                                        if (champs.at(a1) + champs.at(a2) +
                                                                            champs.at(a3) + champs.at(a4) +
                                                                            champs.at(a5) ==
                                                                            champs.at(b1) + champs.at(b2) +
                                                                            champs.at(b3) + champs.at(b4) +
                                                                            champs.at(b5))
                                                                            return false;
                                                                    }
        }
                        ...
                        for (size_t a4 = a3 + 1; a4 < taille; ++a4)
                            for (size_t a5 = a4 + 1; a5 < taille; ++a5)
                                for (size_t a6 = a5 + 1; a6 < taille; ++a6)
                                    for (size_t b1 = a1 + 1; b1 < a6; ++b1)
                                        if (b1 != a2 && b1 != a3 && b1 != a4 && b1 != a5)
                                            for (size_t b2 = b1 + 1; b2 < taille; ++b2)
                                                if (b2 != a2 && b2 != a3 && b2 != a4 && b2 != a5 && b2 != a6)
                                                    for (size_t b3 = b2 + 1; b3 < taille; ++b3)
                                                        if (b3 != a2 && b3 != a3 && b3 != a4 && b3 != a5 && b3 != a6)
                                                            for (size_t b4 = b3 + 1; b4 < taille; ++b4)
                                                                if (b4 != a2 && b4 != a3 && b4 != a4 && b4 != a5 &&
                                                                    b4 != a6)
                                                                    for (size_t b5 = b4 + 1; b5 < taille; ++b5)
                                                                        if (b5 != a2 && b5 != a3 && b5 != a4 &&
                                                                            b5 != a5 && b5 != a6)
                                                                            for (size_t b6 = b5 + 1; b6 < taille; ++b6)
                                                                                if (b6 != a2 && b6 != a3 && b6 != a4 &&
                                                                                    b6 != a5 && b6 != a6) {
                                                                                    if (champs.at(a1) + champs.at(a2) +
                                                                                        champs.at(a3) + champs.at(a4) +
                                                                                        champs.at(a5) + champs.at(a6) ==
                                                                                        champs.at(b1) + champs.at(b2) +
                                                                                        champs.at(b3) + champs.at(b4) +
                                                                                        champs.at(b5) + champs.at(b6))
                                                                                        return false;
                                                                                }
        }
                    ...
                    for (nombre a5 = a4 + 1; a5 < 50; ++a5)
                        for (nombre a6 = a5 + 1; a6 < 50; ++a6)
                            for (nombre a7 = a6 + 1; a7 < 100; ++a7) {
                                ...
                                const nombre somme = std::reduce(std::execution::par, v.begin(), v.end());
