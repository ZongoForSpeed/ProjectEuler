...
ENREGISTRER_PROBLEME(208, "Robot Walks") {
    // A robot moves in a series of one-fifth circular arcs (72°), with a free choice of a clockwise or an anticlockwise
    // arc for each step, but no turning on the spot.
    //    
