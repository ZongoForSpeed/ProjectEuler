...
ENREGISTRER_PROBLEME(301, "Nim") {
    // Nim is a game played with heaps of stones, where two players take it in turn to remove any number of stones from
    // any heap until no stones remain.
    //
    ...
    //
    // zero if, with perfect strategy, the player about to move will eventually lose; or non-zero if, with perfect
