...
void probleme141()
{
	...
	//
	// For example, 58 divided by 6 has quotient 9 and remainder 4. It can also be seen that 4, 6, 9 are 
	// consecutive terms in a geometric sequence (common ratio 3/2).
