...
ENREGISTRER_PROBLEME(306, "Paper-strip Game")
{
    ...
    //           second player loses.
    // If n = 4, there are three valid moves for the first player; she can win 
    //           the game by painting the two middle squares.
    // If n = 5, there are four valid moves for the first player (shown below in 
    //           red); but no matter what she does, the second player (blue) wins.
    //
    //                              R R . B B
    //                              . R R B B
    //                              B B R R .
