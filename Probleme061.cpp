...
ENREGISTRER_PROBLEME(61, "Cyclical figurate numbers")
{
    ...
    do
    {
        ...
        for (nombre n1 = 1010; n1 < 10000; ++n1) if (n1%100 > 9 && polygonal::est_polygonal(n1, t_polygonal[0]))
        for (nombre n2 = 10; n2 < 100; ++n2) if (polygonal::est_polygonal(n1%100 * 100 + n2, t_polygonal[1]))
        for (nombre n3 = 10; n3 < 100; ++n3) if (polygonal::est_polygonal(n2%100 * 100 + n3, t_polygonal[2]))
        for (nombre n4 = 10; n4 < 100; ++n4) if (polygonal::est_polygonal(n3%100 * 100 + n4, t_polygonal[3]))
        for (nombre n5 = 10; n5 < 100; ++n5) if (polygonal::est_polygonal(n4%100 * 100 + n5, t_polygonal[4]))
        {
            const nombre n6 = n1 / 100;
            if (polygonal::est_polygonal(n5%100 * 100 + n6, t_polygonal[5]))
            {
                vecteur s = { n1, n1%100 * 100 + n2, n2%100 * 100 + n3, n3%100 * 100 + n4, n4%100 * 100 + n5, n5%100 * 100 + n6 };
