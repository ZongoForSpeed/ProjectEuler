...
ENREGISTRER_PROBLEME(256, "Tatami-Free Rooms") {
    ...
    //
    // Assuming that the only type of available tatami has dimensions 1×2, there are obviously some limitations for the
    // shape and size of the rooms that can be covered.
    //
