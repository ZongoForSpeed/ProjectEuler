...
BOOST_FIXTURE_TEST_SUITE(test_pythagoricien, fixture_pythagoricien)
    BOOST_AUTO_TEST_CASE(nombres_pythagoricien)
    {
        ...
        BOOST_CHECK_EQUAL_COLLECTIONS(resultat.begin(), resultat.end(), triplets.begin(), triplets.end());
    }
