...
ENREGISTRER_PROBLEME(84, "Monopoly odds")
{
    ...
    //     E3 (3.18%) = Square 24, 
    //     and GO (3.09%) = Square 00. So these three most popular squares can be listed with the 
    ...
    for (nombre c = 0; c < 10000000; ++c)
    {
        ...
        case 36:
            ...
            case 1: position = 0;   break;
            case 2: position = 10;  break;
            case 3: position = 11;  break;
            case 4: position = 24;  break;
    ...
    std::cout << "Solution: " << resultat[0].first << resultat[1].first << resultat[2].first << std::endl;
}
