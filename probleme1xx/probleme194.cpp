...
namespace
{
    ...
    mp_nombre N(std::map<std::tuple<mp_nombre, mp_nombre, mp_nombre>, mp_nombre> & cache, mp_nombre a, mp_nombre b, mp_nombre c)
    {
        if (a == 0 && b == 0)
            return c*(c - 1);
...
ENREGISTRER_PROBLEME(194, "Coloured Configurations")
{
    ...
    std::map<std::tuple<mp_nombre, mp_nombre, mp_nombre>, mp_nombre> cache;
